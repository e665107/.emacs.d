...
(use-package helm
  ...
  (progn
    ...
    (global-set-key (kbd "M-k") 'helm-imenu-anywhere)
    ;; (bind-key* "C-j" 'avy-goto-char)

    ;; (define-key helm-map (kbd "<tab>") 'helm-execute-persistent-action) ; rebihnd tab to do persistent action
    (define-key helm-map (kbd "C-j") 'helm-execute-persistent-action) ; make TAB works in terminal
    (define-key helm-map (kbd "C-q") 'helm-maybe-exit-minibuffer) ; make TAB works in terminal
...
(use-package helm-gtags
  ...
  (add-hook 'Verilog-lisp-mode-hook 'helm-gtags-mode)
  ...
  (eval-after-load "helm-gtags"
    '(progn
       ...
       (define-key helm-gtags-mode-map (kbd "C-c j") 'helm-gtags-find-tag-from-here)
